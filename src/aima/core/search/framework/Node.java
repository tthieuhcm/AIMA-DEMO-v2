 ...
 */
public class Node<S, A> implements Serializable {
     ...
     * node.
     * @param pathCost full pathCost from the root node to here, typically the
     * root's path costs plus the step costs for executing the the specified
     * action.
     */
